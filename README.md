...
* We strive for communication to be thorough and constructive, rather than quick and dirty
...
We encourage test-driven development, but do not enforce it at this time.
...
More complicated tests should have a Given, When, Then description.
